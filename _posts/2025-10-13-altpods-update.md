---
layout: post
title: 'AltPods: pods updated - 1.54.0-SNAPSHOT'
tags: ['bro-gen', binding, robopods, altpods]
---
AltPods were updated to v1.54.0-SNAPSHOT to sync with recent releases.

### Updated pods (ones with API changed)
- [BranchMetrics](https://github.com/dkimitsa/robovm-robopods/tree/dev/v1.54.0/branchmetrics/) `v3.13.0` -> `v3.13.3`
- [Firebase](https://github.com/dkimitsa/robovm-robopods/tree/dev/v1.54.0/firebase/)       `v12.2.0` -> `v12.4.0`
- [Fyber](https://github.com/dkimitsa/robovm-robopods/tree/dev/v1.54.0/fyber)          `v8.3.8` -> `v8.4.0`
